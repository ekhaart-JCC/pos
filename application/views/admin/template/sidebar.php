<div class="wrapper">
            ...
            <div class="leftside-menu">
                ...
                <a href="index.html" class="logo text-center logo-light">
                    <span class="logo-lg">
                        <img src="<?= base_url('assets/'); ?>auth/img/Logo/logo-brand.png" alt="" height="66px" style="margin-top: 20px">
                    </span>
                    <span class="logo-sm">
                        <img src="<?= base_url('assets/'); ?>auth/img/Logo/logo-brand.png" alt="" height="26px">
                    </span>
                </a>
                <div class="h-100" id="leftside-menu-container" data-simplebar="">
                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item text-dark">
                            <a href="employees" class="side-nav-link">
                                <i class="uil-rss"></i>
                                <span> Employees </span>
                            </a>
                        </li>
